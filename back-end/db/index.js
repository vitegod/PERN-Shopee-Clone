...
async function createProduct(productData) {
  const { name, short_description, long_description, price, available_stock_count, img_link, category_id, stock_count } = productData;

  try {
    console.log('Tạo sản phẩm mới...');
    const result = await query(
      `INSERT INTO products (name, short_description, long_description, price, img_link, available_stock_count, stock_count, category_id)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *`,
      [name, short_description, long_description, price, img_link, available_stock_count, stock_count, category_id]
    );
