...
router.post("/upload-product", async (req, res) => {
  try {
    const { name, short_description, long_description, price, available_stock_count, category_id, img_link, seller_id } = req.body;
    ...
    res.status(201).json(newProduct); // Trả về thông tin sản phẩm mới
  } catch (error) {
